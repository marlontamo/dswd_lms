...
use App\Http\Requests\Admin\StoreDirCategoriesRequest;
use App\Http\Requests\Admin\UpdateDirCategoriesRequest;
...
class DirCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $categories = DirCategory::onlyTrashed()->get();
        } else {
            $categories = DirCategory::all();
        }

        return view('backend.dircategories.index', compact('categories'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $categories = DirCategory::onlyTrashed()->orderBy('created_at', 'desc')->get();
        } else {
            $categories = DirCategory::orderBy('created_at', 'desc')->get();
        }
...
//                }
    ...
    public function store(StoreCategoriesRequest $request)
    {
        ...
        $category = DirCategory::where('slug','=',str_slug($request->name))->first();
        if($category == null){
            $category = new  DirCategory();
        }
    ...
    public function edit($id)
    {
        ...
        $category = DirCategory::findOrFail($id);
