...
class BlogController extends Controller
{
    ...
    public function store(StoreBlogsRequest $request)
    {
        ...
        $request = $this->saveNonVideoFiles($request,$path);
        ...
        if ($blog->id) {
            ...
            return redirect()->route('admin.blogs.create')->withFlashDanger(__('alerts.backend.general.error'));
        }
    }
