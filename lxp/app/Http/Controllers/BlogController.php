...
class BlogController extends Controller
{
    ...
    public function getIndex(Request $request)
    {
        ...
        if ($request->slug != "") {
            ...
            $attachements = Media::where(["model_type" => "App\Models\Blog", "model_id" => $blog_id])->limit(1)->first();
            ...
            return view($this->path . '.blogs.blog-single', compact('blog','attachements', 'previous', 'next', 'popular_tags', 'categories', 'related_news'));
        }
