    ...
    <div class="side-bar">
        <div class="side-bar-search">
            <form action="{{route('blogs.search')}}" method="get">
                <input type="text" class="" name="q" placeholder="Search Online Resources">
                <button type="submit"><i class="fas fa-search"></i></button>
            </form>
        </div>
        @if($categories != "")
        <div class="side-bar-widget">
            <h2 class="widget-title text-capitalize">Online Resources <b>Categories</b></h2>
            ...
            <div class="featured-course">
                <div class="best-course-pic-text relative-position pt-0">
                    <div class="best-course-pic relative-position " 
                        @if($global_featured_course->course_image != "") style="background-image: url({{asset('storage/uploads/'.$global_featured_course->course_image)}})" 
                        @endif
                    >
                    </div>
