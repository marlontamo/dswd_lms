        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    ...
                    <h2 class="breadcrumb-head black bold">Online Resources</h2>
                </div>
            </div>
        </div>
    </section>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="blog-post-img-content">
                                                            <div class="blog-img-date relative-position">
                                                                <div class="blog-thumnile" @if($item->image != "")  style="background-image: url({{asset('storage/uploads/blogs/'.$item->image)}})" @endif>
