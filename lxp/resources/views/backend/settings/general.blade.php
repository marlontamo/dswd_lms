                ...
                <div id="general" class="tab-pane container active">
                    <div class="row mt-4 mb-4">
                        <div class="col ">
                            ...
                            <div class="form-group row">
                                {{ html()->label('SWD Forum Register')->class('col-md-2 form-control-label')->for('swdforum_register') }}
                                <div class="col-md-10">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('swdforum_register', config('swdforum_register') ? true : false,1)->id('swdforum_register')
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
