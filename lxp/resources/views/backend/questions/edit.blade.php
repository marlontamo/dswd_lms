...
@section('content')
    ...
    {!! Form::model($question, ['method' => 'PUT', 'route' => ['admin.questions.update', $question->id], 'files' => true,'onsubmit'=>'check(event)']) !!}
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 form-group">
                    <input type="hidden" value = "{{$question->act_type}}"></input>
                    <h5 class="page-title">Activity Type:
                    <label for="">
                        @if($question->act_type == 2)
                            Activity Output
                        @else
                            Multiple Choice
                        @endif
            ...
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('question_image', trans('labels.backend.questions.fields.question_image'), ['class' => 'control-label','id'=>'edit-form']) !!}
                    {!! Form::file('question_image', ['class' => 'form-control', 'style' => 'margin-top: 4px;']) !!}
                    {!! Form::hidden('question_image_max_size', 8) !!}
                    {!! Form::hidden('question_image_max_width', 4000) !!}
                    {!! Form::hidden('question_image_max_height', 4000) !!}
    ...
    <div class="row">
        ...
        <div class="col-12 text-center mb-4">
            {!! Form::submit(trans('strings.backend.general.app_update'), ['class' => 'btn btn-danger update', 'id'=>'edit', 'onclick'=>'validate()']) !!}
