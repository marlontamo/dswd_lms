...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                <h3 class="page-title d-inline">Subject Matter Experts / Instructional Designers </h3>
            @can('course_create')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        ...
                        <table id="myTable"
                               class="table table-bordered table-striped @if(auth()->user()->isSuperAdmin()) @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                            <thead>
                                <tr>
                                    @can('category_delete')
