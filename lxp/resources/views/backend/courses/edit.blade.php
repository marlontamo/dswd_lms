...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if (Auth::user()->isSuperAdmin() || Auth::user()->name === "Admin Team")
            ...
            <div class="row">
                ...
                <div class="col-8 form-group">
                    ...
                    {!! Form::select('prerequisite[]',  $courses->prepend('None', 0), old('prerequisite'), ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => true, 'placeholder' => 'Select Prerequisite Course/s']) !!}
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-3 form-group">
                    ...
                    {!! Form::number('duration_days', old('duration_days'), ['class' => 'form-control', 'placeholder' => '', 'required' => '', 'min' => '1', 'max'=>'30']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 form-group">
                    {!! Form::label('add_video', trans('labels.backend.lessons.fields.add_video'), ['class' => 'control-label']) !!}
                    {!! Form::select('media_type', ['youtube' => 'Youtube','upload' => 'Upload'],($course->mediavideo) ? $course->mediavideo->type : null,['class' => 'form-control', 'placeholder' => 'Select One','id'=>'media_type' ]) !!}
