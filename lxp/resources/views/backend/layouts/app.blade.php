...
@if(config('app.display_type') == 'rtl' || (session()->has('display_type') && session('display_type') == 'rtl'))
    ...
    @else
        ...
        <head>
            ...
            <link rel="stylesheet"
                  href="{{asset('assets/css/select.dataTables.min.css')}}"/>
            <link rel="stylesheet"
                  href="{{asset('assets/css/buttons.dataTables.min.css')}}"/>
            {{--<link rel="stylesheet"--}}
            {{--href="{{asset('assets/css/bootstrap-datepicker.standalone.min.css')}}"/>--}}
